...
public class Main {
  ...
  // YOUR ANSWER HERE: hashmap because of the keys
  ...
  // What would be a good choice of data structure?
  // YOUR ANSWER HERE: ArrayList to keep songs in speicifc order
  ...
  // What would be a good choice of data structure?
  // YOUR ANSWER HERE: ArrayList so you can store and display recent searches 
}